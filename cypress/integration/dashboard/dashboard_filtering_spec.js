...
describe('dashboard filtering', () => {
  before(() => {
    ...
    // TO DO: Setup the indices (see https://github.com/AvivBenchorin/monterey/issues/11)
  ...
  after(() => {
    // TO DO: Tear-down the indices (see https://github.com/AvivBenchorin/monterey/issues/11)
