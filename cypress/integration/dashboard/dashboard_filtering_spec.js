...
describe('dashboard filtering', () => {
  ...
  describe('Adding and removing filters from a dashboard', () => {
    before(() => {
      ...
      cy.setDateRange('Apr 13, 2018 @ 00:00:00.000', 'Jan 1, 2018 @ 00:00:00.000')
    ...
    describe('adding a filter that excludes all data', () => {
      before(() => {
        ...
        // Add filter
        cy.addFilterRetrySelection('bytes', 'is', '12345678')
      })
  ...
  describe('nested filtering', () => {
    ...
    it('visualization saved with a query filters data', () => {
      ...
      cy.saveDashboardVisualization('Rendering Test: animal sounds pie', false, false)
    ...
    it('Nested visualization filter pills filters data as expected', () => {
      ...
      cy.saveDashboardVisualization('animal sounds pie', false, false)
